...
DEFAULT_USRP_DEVICE_ARGS: str = "type=b200"
DEFAULT_USRP_CENTER_FREQUENCY_MHZ: float = 2400.0
DEFAULT_USRP_SAMPLE_RATE_MHZ: float = 1.0
DEFAULT_USRP_BANDWIDTH_MHZ: float = 10.0
DEFAULT_USRP_GAIN_DB: float = 20.0
DEFAULT_USRP_DURATION_S: float = 2.0
DEFAULT_USRP_ANTENNA: str = "RX2"
UHD_DEFAULT_INSTALL_DIR: Path = Path("C:/Program Files/UHD")
